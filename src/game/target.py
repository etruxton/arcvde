        ...
        if not self.hit:
            ...
            if time_since_hit < self.hit_animation_duration:
                ...
                if ring1_alpha > 0:
                    ...
                    pygame.draw.circle(ring1_surface, (*YELLOW, ring1_alpha), 
                                     (ring1_radius, ring1_radius), ring1_radius, 3)
                ...
                if ring2_alpha > 0:
                    ...
                    pygame.draw.circle(ring2_surface, (*WHITE, ring2_alpha), 
                                     (ring2_radius, ring2_radius), ring2_radius, 2)
