    ...
    def draw(self):
        ...
        if self.phase == "fade_in" or self.fade_alpha > 0:
            ...
            scaled_logo = pygame.transform.scale(
                self.logo, (int(logo_rect.width * self.logo_scale), int(logo_rect.height * self.logo_scale))
            )
            ...
            if self.phase == "loading":
                ...
                pulse_logo = pygame.transform.scale(
                    scaled_logo, (int(scaled_rect.width * pulse), int(scaled_rect.height * pulse))
                )
    ...
    def _draw_loading_elements(self):
        ...
        if self.progress > 0:
            ...
            for x in range(fill_width):
                ...
                pygame.draw.line(self.screen, (r, g, b), (bar_x + x, bar_y), (bar_x + x, bar_y + bar_height))
