...
class SettingsScreen(BaseScreen):
    ...
    def _create_ui_elements(self) -> None:
        ...
        for i, camera_id in enumerate(available_cameras):
            ...
            button = Button(
                ...
                f"Cam {camera_id}", self.button_font
            )
        ...
        self.test_button = Button(
            start_x, start_y + 150, 150, button_height,
            "TEST CAMERA", self.button_font
        )
        
        # Apply/Save button
        self.apply_button = Button(
            start_x + 200, start_y + 150, 100, button_height,
            "APPLY", self.button_font
        )
    ...
    def draw(self) -> None:
        ...
        current_text = f"Current: Camera {camera_info['current_id']} ({camera_info['resolution'][0]}x{camera_info['resolution'][1]})"
